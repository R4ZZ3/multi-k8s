...
kubectl set image deployments/client-deployment client=rasmust92/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=rasmust92/multi-worker:$SHA